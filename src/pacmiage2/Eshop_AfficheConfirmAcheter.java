...
public class Eshop_AfficheConfirmAcheter extends AbstractAction {
    ...
    public Eshop_AfficheConfirmAcheter(Objet it) {
        this.it = it;
    }
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        Eshop_BtnConfirmAchat oui = new Eshop_BtnConfirmAchat();
        Eshop_BtnRetourEshop non = new Eshop_BtnRetourEshop(f);
        g.add(texte);
        g.add(oui);
        g.add(non);
        graine.setBounds(largeur / 2, 0, 150*largeur/1360, 150*hauteur/768);
